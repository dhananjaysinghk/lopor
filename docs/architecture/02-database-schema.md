# PostgreSQL & pgvector Complete Database Schema

## 1. Relational Entity Relationship Architecture

The **Lopor** relational model enforces multi-tenancy at the **Organization** and **Workspace** levels with Row-Level Security (RLS) readiness, cascade cleanup policies, and pgvector HNSW indexing.
...
CREATE INDEX idx_chats_workspace_user ON chats(workspace_id, user_id);
...
-- 15. EMBEDDINGS (RAG VECTOR STORE)
