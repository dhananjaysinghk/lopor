    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl relative z-10">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-xl font-bold text-white tracking-tight">Create your Lopor Account</h1>
          <p className="text-xs text-zinc-400 mt-1">Start collaborating with production AI</p>
        </div>
